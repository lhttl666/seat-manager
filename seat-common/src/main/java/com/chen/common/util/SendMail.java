...
public class SendMail {
    ...
    public static String myEmailAccount = "gangsterchen@163.com";
    public static String myEmailPassword = "ODLEZQKPRAVIZPFK";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "910326532@qq.com";
